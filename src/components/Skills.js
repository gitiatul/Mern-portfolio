...
import { SiCplusplus, SiMongodb, SiFirebase, SiMysql } from "react-icons/si";
      ...
      <div className="flex md:flex-row flex-col justify-around p-2">
        <div className="md:w-2/5">
          ...
          <div className="flex flex-wrap">
            ...
            <SkillComponent title="React Native" icon={<FaReact size={80} />} />
      ...
      <div className="flex md:flex-row flex-col justify-around p-2 my-3">
        ...
        <div className="md:w-2/5">
          ...
          <div className="flex">
            ...
            <SkillComponent title="C++" icon={<SiCplusplus size={80} />} />
          </div>
        </div>
      </div>
    </div>
